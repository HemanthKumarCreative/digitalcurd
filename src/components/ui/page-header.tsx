  ...
  <div className={cn('mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between', className)}>
    <div className="min-w-0">
      {breadcrumbs && breadcrumbs.length > 0 ? (
        <nav className="mb-2 flex flex-wrap items-center gap-1 text-xs text-[var(--admin-text-muted)]" aria-label="Breadcrumb">
      ...
      <h1 className="text-2xl font-bold tracking-tight text-[var(--admin-navy)] lg:text-[1.75rem]">
        {title}
      </h1>
      {description ? (
